...
var Chapter1 = (function () {
  ...
  var npcs = {
    ...
    selene: {
      id: "selene", name: "Selene Ashford",
      portrait: "assets/portraits/innkeeper.png",
      role: "Innkeeper", personality: "Warm, perceptive, quietly caring. Keeps the hearth burning and everyone's secrets safe."
    },
    liora: {
  ...
  var dialogues = {
    ...
    "liora-first": {
      id: "liora-first",
      nodes: [
        { speaker: "Liora Bloom", portrait: npcs.liora.portrait, text: "Oh! Hello there. I don't think I've seen you at my stall before. I'm Liora, I sell flowers, herbs, and the occasional ribbon when Mira doesn't beat me to it." },
        { speaker: "Liora Bloom", portrait: npcs.liora.portrait, text: "I know, I know. A flower stall in a town under goblin siege. People keep saying it's impractical. I keep saying beauty is the first thing worth defending." },
        { speaker: "Liora Bloom", portrait: npcs.liora.portrait, text: "Stop by whenever you like. I tend to be here most mornings, and I'm a much better listener than the quest board." }
      ],
      onEnd: { flags: ["visitedLiora"] }
    },
    "sq-meditate-complete": {
      id: "sq-meditate-complete",
      nodes: [
        { speaker: "Elira Ashfen", portrait: npcs.elira.portrait, text: "You've done it. The goblin brutes fell, the shamans are gone, and you recovered the shadow essence. The monk's trial is complete." },
        { speaker: "Elira Ashfen", portrait: npcs.elira.portrait, text: "What you earned isn't just a technique. Meditation is how you survive what's coming. When the world is loud and dangerous, silence becomes a weapon." },
        { speaker: "Elira Ashfen", portrait: npcs.elira.portrait, text: "Use it wisely." }
      ]
    },
    "sq-double-strike-complete": {
      id: "sq-double-strike-complete",
      nodes: [
        { speaker: "Bram Ironhand", portrait: npcs.bram.portrait, text: "You actually did it. Every last target on that list. I'll be honest, I wasn't sure you'd manage the ore on top of everything else." },
        { speaker: "Bram Ironhand", portrait: npcs.bram.portrait, text: "The technique I'm about to show you isn't complicated. But it'll take everything you've built so far to land it cleanly." },
        { speaker: "Bram Ironhand", portrait: npcs.bram.portrait, text: "Strike once to open the guard. Strike twice to end the fight. Now you know how. Don't waste it on small game." }
      ]
    },
    "elric-first": {
      id: "elric-first",
    ...
    "lysara-first": {
      ...
      nodes: [
        ...
        { speaker: "Dame Lysara", portrait: npcs.lysara.portrait, text: "I must warn you: you may only choose one class path, and once that oath is sworn, it is permanent. Do you wish to start the Knight quest line?", choices: [
          { text: "Start the Knight quest line.", flags: ["metLysara"], quest: "cq-knight", next: 4 },
          { text: "Not yet.", next: 5 }
        ] },
        { speaker: "Dame Lysara", portrait: npcs.lysara.portrait, text: "Then prepare yourself well. Return to me when you are ready to fulfill the trial.", end: true },
        { speaker: "Dame Lysara", portrait: npcs.lysara.portrait, text: "Take your time. The oath will be here when you are ready to swear it.", end: true }
      ]
    },
    "grul-first": {
      id: "grul-first",
      nodes: [
        ...
        { speaker: "Grul", portrait: npcs.grul.portrait, text: "Warning. You pick one path. Only one. Forever. Is permanent. You want Berserker path?", choices: [
          { text: "Start the Berserker quest line.", flags: ["metGrul"], quest: "cq-berserker", next: 4 },
          { text: "Not yet.", next: 5 }
        ] },
        { speaker: "Grul", portrait: npcs.grul.portrait, text: "Good. Crush goblin raiders. Tear through wolf packs. Bring Grul victory. Then Grul teaches.", end: true },
        { speaker: "Grul", portrait: npcs.grul.portrait, text: "Grul waits. Come back when ready to unleash the storm.", end: true }
      ]
    },
    "whisper-first": {
      id: "whisper-first",
      nodes: [
        ...
        { speaker: "Whisper", portrait: npcs.whisper.portrait, text: "One warning before you answer. The path you choose is permanent. No going back. Do you want to start the Assassin quest line?", choices: [
          { text: "Start the Assassin quest line.", flags: ["metWhisper"], quest: "cq-assassin", next: 3 },
          { text: "Not yet.", next: 4 }
        ] },
        { speaker: "Whisper", portrait: npcs.whisper.portrait, text: "Good. Complete the contract and I will teach you the assassin's way. Fail, and we never had this conversation.", end: true },
        { speaker: "Whisper", portrait: npcs.whisper.portrait, text: "Then come back when you've decided. I'll still be here. You just won't see me.", end: true }
      ]
    },
    "fenn-first": {
      id: "fenn-first",
      nodes: [
        ...
        { speaker: "Warden Fenn", portrait: npcs.fenn.portrait, text: "Understand before you answer: you may only choose one class path, and the choice is permanent. Do you want to start the Ranger quest line?", choices: [
          { text: "Start the Ranger quest line.", flags: ["metFenn"], quest: "cq-ranger", next: 4 },
          { text: "Not yet.", next: 5 }
        ] },
        { speaker: "Warden Fenn", portrait: npcs.fenn.portrait, text: "Good. Hunt goblin archers, track wolves to their dens, and gather moonpetal before the goblins trample it all. Then return to me.", end: true },
        { speaker: "Warden Fenn", portrait: npcs.fenn.portrait, text: "The forest isn't going anywhere. Come back when you're ready.", end: true }
      ]
    },
    "cindra-first": {
      id: "cindra-first",
      nodes: [
        ...
        { speaker: "Cindra", portrait: npcs.cindra.portrait, text: "Fair warning: one path only, and it's permanent, no take-backs! Do you want to start the Pyromancer quest line?", choices: [
          { text: "Start the Pyromancer quest line.", flags: ["metCindra"], quest: "cq-pyromancer", next: 4 },
          { text: "Not yet.", next: 5 }
        ] },
        { speaker: "Cindra", portrait: npcs.cindra.portrait, text: "Prove you can handle the heat. Destroy goblin shamans, gather shadow essence and moonpetal. Then I'll show you what real power looks like.", end: true },
        { speaker: "Cindra", portrait: npcs.cindra.portrait, text: "Fine! Come back when you're ready to commit to the flame. I'll be here. Probably fine.", end: true }
      ]
    },
    "maren-first": {
      id: "maren-first",
      nodes: [
        ...
        { speaker: "Sister Maren", portrait: npcs.maren.portrait, text: "Know that this calling is a commitment. You may only choose one path, and once you answer, there is no going back. Do you wish to start the Cleric quest line?", choices: [
          { text: "Start the Cleric quest line.", flags: ["metMaren"], quest: "cq-cleric", next: 4 },
          { text: "Not yet.", next: 5 }
        ] },
        { speaker: "Sister Maren", portrait: npcs.maren.portrait, text: "Gather sacred moonpetal, stand against the goblin brutes who prey on the helpless, and bring shadow essence to be purified. Then your training begins.", end: true },
        { speaker: "Sister Maren", portrait: npcs.maren.portrait, text: "Take the time you need. The Light is patient. I will be here.", end: true }
      ]
    },
    "cedric-first": {
      id: "cedric-first",
      nodes: [
        ...
        { speaker: "Sir Cedric", portrait: npcs.cedric.portrait, text: "Be certain before you answer. The sacred rites bind you to one path permanently. Do you wish to start the Paladin quest line?", choices: [
          { text: "Start the Paladin quest line.", flags: ["metCedric"], quest: "cq-paladin", next: 4 },
          { text: "Not yet.", next: 5 }
        ] },
        { speaker: "Sir Cedric", portrait: npcs.cedric.portrait, text: "Complete my crucible. Face the strongest foes, gather iron and moonpetal, and return to me. Then, and only then, will I pass on the sacred rites.", end: true },
        { speaker: "Sir Cedric", portrait: npcs.cedric.portrait, text: "A measured choice is a wise one. I will be here when you are ready.", end: true }
      ]
    },
