...
var Enemies = (function () {
  ...
  var enemies = {
    ...
    "dire-rat": {
      ...
      hp: 18, attack: 4, defense: 0, xp: 4, gold: [1, 4],
      loot: [
    ...
    "wolf": {
      ...
      hp: 28, attack: 5, defense: 1, xp: 5, gold: [2, 5],
      loot: [
    ...
    "goblin-scout": {
      ...
      hp: 24, attack: 4, defense: 1, xp: 7, gold: [3, 6],
      loot: [
    ...
    "goblin-sneak": {
      ...
      hp: 28, attack: 6, defense: 1, xp: 8, gold: [4, 7],
      loot: [
    ...
    "goblin-raider": {
      ...
      hp: 36, attack: 7, defense: 2, xp: 10, gold: [5, 10],
      loot: [
        { id: "goblin-fang", chance: 0.40 },
    ...
    "goblin-archer": {
      ...
      hp: 24, attack: 8, defense: 1, xp: 10, gold: [4, 9],
      loot: [
        { id: "goblin-fang", chance: 0.35 },
    ...
    "wolf-pack": {
      ...
      hp: 40, attack: 7, defense: 2, xp: 11, gold: [3, 6],
      loot: [
    ...
    "goblin-guard": {
      ...
      hp: 48, attack: 8, defense: 4, xp: 14, gold: [6, 12],
      loot: [
    ...
    "goblin-shaman": {
      ...
      hp: 35, attack: 9, defense: 2, xp: 15, gold: [5, 11],
      loot: [
    ...
    "goblin-brute": {
      ...
      hp: 58, attack: 10, defense: 3, xp: 17, gold: [8, 15],
      loot: [
    ...
    "bandit": {
      ...
      hp: 34, attack: 7, defense: 2, xp: 11, gold: [5, 10],
      loot: [
    ...
    "snow-wolf": {
      ...
      hp: 34, attack: 7, defense: 2, xp: 8, gold: [3, 7],
      loot: [
    ...
    "frost-goblin": {
      ...
      hp: 32, attack: 7, defense: 3, xp: 10, gold: [4, 8],
      loot: [
        { id: "goblin-fang", chance: 0.40 },
    ...
    "snow-bandit": {
      ...
      hp: 38, attack: 9, defense: 3, xp: 12, gold: [6, 12],
      loot: [
        { id: "torn-cloth", chance: 0.35 },
        { id: "rusted-scrap", chance: 0.25 },
    ...
    "goblin-chief-grisk": {
      ...
      hp: 150, attack: 12, defense: 5, xp: 150, gold: [50, 80],
      isBoss: true,
      phases: [
